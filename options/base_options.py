...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--nif', type=int, default=32,
                                 help='# of transformation filters on top of input and output')
        ...
        self.parser.add_argument('--print_weights', action='store_true',
                                 help='print initial weights of the netG1 network')
        self.parser.add_argument('--orna', action='store_true',
                                 help='only consider OrnaNet and should have full b/w inputs in A')
